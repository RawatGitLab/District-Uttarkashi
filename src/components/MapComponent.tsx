...
export default function MapComponent({
  ...
  return (
    <div className="relative flex-1 bg-slate-100 dark:bg-slate-950 flex flex-col h-full min-w-0">
      ...
      <div className="absolute bottom-4 left-4 z-[1000] bg-white/95 dark:bg-slate-900/95 backdrop-blur border border-slate-200 dark:border-slate-800 shadow-md px-4 py-2.5 rounded-lg flex flex-col md:flex-row md:items-center gap-3 md:gap-6 text-xs font-mono text-slate-600 dark:text-slate-300 transition-all">
        <div className="flex items-center gap-2">
          <Move className="w-3.5 h-3.5 text-indigo-500 dark:text-indigo-400" />
          <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider">Geographic:</span>
          <span>Lng: <strong ref={lngRef} className="text-slate-800 dark:text-slate-100">78.61211</strong></span>
          <span className="text-slate-300 dark:text-slate-700">|</span>
          <span>Lat: <strong ref={latRef} className="text-slate-800 dark:text-slate-100">30.96755</strong></span>
        </div>
        <div className="hidden md:block h-4 w-px bg-slate-200 dark:bg-slate-800" />
        <div className="flex items-center gap-2">
          <span className="text-[10px] font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-wider">UTM Zone 44N:</span>
          <span>E (X): <strong ref={utmXRef} className="text-slate-800 dark:text-slate-100">---</strong> m</span>
          <span className="text-slate-300 dark:text-slate-700">|</span>
          <span>N (Y): <strong ref={utmYRef} className="text-slate-800 dark:text-slate-100">---</strong> m</span>
        </div>
        <div className="hidden md:block h-4 w-px bg-slate-200 dark:bg-slate-800" />
        <div className="flex items-center gap-2">
          <span className="text-[10px] font-bold text-sky-600 dark:text-sky-400 uppercase tracking-wider">India LCC:</span>
          <span>E (X): <strong ref={lccXRef} className="text-slate-800 dark:text-slate-100">---</strong> m</span>
          <span className="text-slate-300 dark:text-slate-700">|</span>
          <span>N (Y): <strong ref={lccYRef} className="text-slate-800 dark:text-slate-100 font-bold">---</strong> m</span>
        </div>
        <div className="hidden md:block h-4 w-px bg-slate-200 dark:bg-slate-800" />
        <div className="text-[11px] font-semibold text-slate-500 dark:text-slate-400">
          Zoom: <span className="text-indigo-600 dark:text-indigo-400 font-bold">{zoomLevel}</span>
        </div>
      </div>
        ...
        <div className="relative flex items-center bg-white/95 dark:bg-slate-900/95 backdrop-blur border border-slate-200 dark:border-slate-800 rounded-lg shadow-md transition-shadow duration-200 focus-within:shadow-lg focus-within:border-indigo-400 dark:focus-within:border-indigo-500">
          ...
          {mapSearchQuery ? (
            <button
              ...
              className="absolute right-2.5 p-1 text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300 rounded-md hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
            >
            ...
            {filteredSearchFeatures.map((feat) => {
              ...
              return (
                <button
                  ...
                  className="w-full text-left px-3.5 py-2.5 hover:bg-indigo-50/70 dark:hover:bg-indigo-950/60 active:bg-indigo-100 text-xs text-slate-700 dark:text-slate-200 font-medium transition-colors flex items-center justify-between gap-1 border-none bg-transparent cursor-pointer"
                >
                  ...
                  <span className="text-[9px] uppercase tracking-wider bg-slate-100 dark:bg-slate-800 text-slate-400 dark:text-slate-500 font-bold px-1.5 py-0.5 rounded font-mono shrink-0">
